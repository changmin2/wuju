          ...
          children: <Widget>[
                  ...
                  Container(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          padding: EdgeInsets.zero,
                          backgroundColor:
                              btnClick[5] ? Color(0xff12887A) : Colors.white,
                          side: BorderSide(
                            color: Colors.black,
                          ),
                        ),
                  ...
                  Container(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          padding: EdgeInsets.zero,
                          backgroundColor:
                              btnClick[6] ? Color(0xff12887A) : Colors.white,
                          side: BorderSide(
                            color: Colors.black,
                          ),
                        ),
            ...
            ElevatedButton(
              ...
              child: clickStartTime
                  ? Text("${startTime.hour}시 ${startTime.minute}분",
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            List<String> poDay = [];
            var po = btnClick
                .map((e) => e ? day[btnClick.indexOf(e)].toString() : null)
                .toList();
            ...
            if (poDay.length < 1) {
              ...
              ref.read(alienProvider.notifier).fifth(
                  poDay,
