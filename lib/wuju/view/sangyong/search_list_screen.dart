...
class _SearchListScreenState extends ConsumerState<SearchListScreen> {
    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if(snapshot.hasData == false){
          ...
          child: Column(
            children: [
              _renderMyTownDropDownButton(context,ref),
              SizedBox(
                height: 20,
              ),
              Center(
  ...
  Row _renderMyTownDropDownButton(context,WidgetRef ref) {
    return Row(
      children: [
        SizedBox(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton(
                ...
                onChanged: (v) {
                  ...
                  setState(() {
                    ref.read(addressNotiferProvider.notifier).first(v.toString());
                    si = v;
                  });
                }),
          ),
...
// 외계인 찾기
//---------------------------------------------------------
  Widget _renderSearchList(List<UserModel> lists) {
    ...
    return Expanded(
      child: GridView.builder(
        ...
        itemBuilder: (BuildContext context, index) => _renderHumanCard(context,lists[index]),
      ),
    );
  }
}
...
// 외계인 카드
//---------------------------------------------------------
Widget _renderHumanCard(context,UserModel user) {
  return HumanCard(
